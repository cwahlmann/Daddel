...
|Konvention steht über Konfiguration - mit minimalem Code lassen sich anschauliche Ergebnisse erzielen; basierend auf JavaFx; einige Grafiken.footnote[diese stammen z.T. von https://www.openclipart.org] und Sounds.footnote[Additional sound effects from https://www.zapsplat.com - sehr zu empfehlen] werden bereits mitgeliefert
